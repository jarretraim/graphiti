...
/**
 * @class graphiti.shape.icon.People

 * See the example:
 *
 *     @example preview small frame
 *     
 *     var icon =  new graphiti.shape.icon.People();
 ...
 */
graphiti.shape.icon.People = graphiti.shape.icon.Icon.extend({
    NAME : "graphiti.shape.icon.People",
