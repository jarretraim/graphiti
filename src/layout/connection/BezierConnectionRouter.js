 ...
 * @constructor
 */
/*:NAMESPACE*/BezierConnectionRouter=function(/*:boolean*/ noCheapRouter)
{
//   if(!noCheapRouter)
//      this.cheapRouter = new /*:NAMESPACE*/ManhattanConnectionRouter();
//   else
      this.cheapRouter=null;
   this.iteration=5;
};

/*:NAMESPACE*/BezierConnectionRouter.prototype = new /*:NAMESPACE*/ConnectionRouter();
/*:NAMESPACE*/BezierConnectionRouter.prototype.type="@NAMESPACE@BezierConnectionRouter";


/*:NAMESPACE*/BezierConnectionRouter.prototype.drawBezier=function(/*:Array*/pointArray,/*:Array*/resultArray, /*:float*/t, /*:int*/iter)
{
  ...
  for (var j = 1; j <= n; j++)
  {
    for (var i = 0; i <= (n-j); i++)
    {
      q[i][j] = new /*:NAMESPACE*/Point((1 - t) * q[i][j - 1].x + t * q[i + 1][j - 1].x,
...
/**
 * @see @NAMESPACE@ConnectionRouter#route(Connection)
 */
/*:NAMESPACE*/BezierConnectionRouter.prototype.route=function(/*:@NAMESPACE@Connection*/ conn)
{
 ...
 * @private
 **/
/*:NAMESPACE*/BezierConnectionRouter.prototype._route=function(pointList, /*:@NAMESPACE@Connection*/ conn,/*:@NAMESPACE@Point*/ fromPt, /*:int*/fromDir, /*:@NAMESPACE@Point*/toPt, /*:int*/toDir)
{
   var TOL     = 0.1;
   var TOLxTOL = 0.01;
   var MINDIST = 90;
